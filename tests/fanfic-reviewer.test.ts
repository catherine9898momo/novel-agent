...
const PLAN: FanficShortPlan = {
  ...
  scenes: [
    { order: 1, title: "旧信", purpose: "引出", wordBudget: 25, beats: ["发现旧信", "长廊雨声"], requiredScenes: ["藏在书页里的旧信", "长廊雨声"], canonConstraints: ["不逼问"], emotionalTurn: "心软" },
    { order: 2, title: "相遇", purpose: "靠近", wordBudget: 25, beats: ["陆承舟出现", "不点破"], requiredScenes: [], canonConstraints: ["克制"], emotionalTurn: "升温" },
    { order: 3, title: "共伞", purpose: "行动表达", wordBudget: 25, beats: ["伞偏向她", "肩头湿"], requiredScenes: [], canonConstraints: ["自持"], emotionalTurn: "明白" },
    { order: 4, title: "留信", purpose: "余韵", wordBudget: 25, beats: ["信放回", "次日离别"], requiredScenes: [], canonConstraints: ["只剩一夜"], emotionalTurn: "希望" }
  ],
