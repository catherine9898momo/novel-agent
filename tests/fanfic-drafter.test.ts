...
const PLAN: FanficShortPlan = {
  ...
  scenes: [
    { order: 1, title: "旧信被发现", purpose: "引出未说出口的心意", wordBudget: 25, beats: ["沈知晚在书页里发现旧信", "长廊雨声压住翻页声"], requiredScenes: ["藏在书页里的旧信", "长廊雨声"], canonConstraints: ["沈知晚不会逼问"], emotionalTurn: "疑心转为心软" },
    { order: 2, title: "廊下相遇", purpose: "让两人回避又靠近", wordBudget: 25, beats: ["陆承舟出现", "两人都不点破旧信"], requiredScenes: [], canonConstraints: ["陆承舟习惯克制"], emotionalTurn: "克制升温" },
    { order: 3, title: "雨夜共伞", purpose: "用行动替代告白", wordBudget: 25, beats: ["他把伞偏向她", "她看见他肩头淋湿"], requiredScenes: [], canonConstraints: ["不要破坏陆承舟一贯自持"], emotionalTurn: "明白但不说破" },
    { order: 4, title: "信留书页", purpose: "开放式 HE 收束", wordBudget: 25, beats: ["她把信放回书页", "次日离别留下余味"], requiredScenes: [], canonConstraints: ["离开前只剩一夜"], emotionalTurn: "离别中保留希望" }
  ],
